/*
  ...
  based on the authoritative Wikipedia "List of Munro mountains" page.
  
  Key corrections:
  - Ben Macdui: 950m prominence (not 1309m which is height)
  - Braeriach: 461m prominence
  - Ben Nevis: 1345m prominence (same as height - highest in UK)
  - All other Munros with correct Wikipedia prominence values
...
UPDATE munros SET prominence_m = 1132 WHERE name = 'Geal-chàrn';
...
UPDATE munros SET prominence_m = 1118 WHERE name = 'Meall Garbh';
...
UPDATE munros SET prominence_m = 1116 WHERE name = 'Aonach Beag';
...
UPDATE munros SET prominence_m = 1084 WHERE name = 'Beinn Dearg';
UPDATE munros SET prominence_m = 1083 WHERE name = 'Schiehallion';
UPDATE munros SET prominence_m = 1083 WHERE name = 'Sgùrr a'' Choire Ghlais';
UPDATE munros SET prominence_m = 1082 WHERE name = 'Beinn a'' Chaorainn';
...
UPDATE munros SET prominence_m = 1069 WHERE name = 'An Socach';
...
UPDATE munros SET prominence_m = 1062 WHERE name = 'Bidein a'' Ghlas Thuill';
UPDATE munros SET prominence_m = 1060 WHERE name = 'Sgùrr Fiona';
UPDATE munros SET prominence_m = 1056 WHERE name = 'Na Gruagaichean';
UPDATE munros SET prominence_m = 1055 WHERE name = 'Spidean a'' Choire Lèith';
...
UPDATE munros SET prominence_m = 1050 WHERE name = 'Beinn a'' Chaorainn';
UPDATE munros SET prominence_m = 1049 WHERE name = 'Geal chàrn';
...
UPDATE munros SET prominence_m = 1047 WHERE name = 'Creag Mhòr';
...
UPDATE munros SET prominence_m = 1034 WHERE name = 'Càrn Dearg';
...
UPDATE munros SET prominence_m = 1023 WHERE name = 'Mullach an Rathain';
UPDATE munros SET prominence_m = 1021 WHERE name = 'Aonach Air Chrith';
UPDATE munros SET prominence_m = 1021 WHERE name = 'Stob Dearg';
...
UPDATE munros SET prominence_m = 1010 WHERE name = 'Ruadh-stac Mòr';
...
UPDATE munros SET prominence_m = 1008 WHERE name = 'Beinn Dearg';
...
UPDATE munros SET prominence_m = 1006 WHERE name = 'Càrn Liath';
UPDATE munros SET prominence_m = 1005 WHERE name = 'Beinn Fhionnlaidh';
...
UPDATE munros SET prominence_m = 1003 WHERE name = 'Sgùrr Mòr';
...
UPDATE munros SET prominence_m = 1001 WHERE name = 'Sgòrr Dhònuill';
...
UPDATE munros SET prominence_m = 997 WHERE name = 'A'' Chailleach';
...
UPDATE munros SET prominence_m = 994 WHERE name = 'Càrn an Fhìdhleir';
...
UPDATE munros SET prominence_m = 993 WHERE name = 'Spidean Coire nan Clach';
UPDATE munros SET prominence_m = 992 WHERE name = 'Càrn nan Gobhar';
...
UPDATE munros SET prominence_m = 986 WHERE name = 'Sgùrr Mòr';
UPDATE munros SET prominence_m = 985 WHERE name = 'Ben Vorlich';
...
UPDATE munros SET prominence_m = 981 WHERE name = 'Creag Mhòr';
...
UPDATE munros SET prominence_m = 968 WHERE name = 'Meall Garbh';
UPDATE munros SET prominence_m = 967 WHERE name = 'A'' Mhaighdean';
UPDATE munros SET prominence_m = 967 WHERE name = 'Sgòrr nam Fiannaidh';
UPDATE munros SET prominence_m = 966 WHERE name = 'Ben More';
...
UPDATE munros SET prominence_m = 956 WHERE name = 'Sgùrr nan Coireachan';
UPDATE munros SET prominence_m = 956 WHERE name = 'Stob Dubh';
UPDATE munros SET prominence_m = 956 WHERE name = 'Stob na Bròige';
...
UPDATE munros SET prominence_m = 953 WHERE name = 'Meall Dearg';
UPDATE munros SET prominence_m = 953 WHERE name = 'Sgùrr nan Coireachan';
...
UPDATE munros SET prominence_m = 946 WHERE name = 'Meall Buidhe';
UPDATE munros SET prominence_m = 945 WHERE name = 'Bidein a'' Choire Sheasgaich';
UPDATE munros SET prominence_m = 945 WHERE name = 'Càrn Dearg';
...
UPDATE munros SET prominence_m = 932 WHERE name = 'Meall Buidhe';
UPDATE munros SET prominence_m = 931 WHERE name = 'Beinn Bhreac';
UPDATE munros SET prominence_m = 931 WHERE name = 'Ben Chonzie';
UPDATE munros SET prominence_m = 930 WHERE name = 'A'' Chailleach';
...
UPDATE munros SET prominence_m = 926 WHERE name = 'Geal Chàrn';
...
UPDATE munros SET prominence_m = 925 WHERE name = 'Stob Coire Raineach';
...
UPDATE munros SET prominence_m = 922 WHERE name = 'Tom na Gruagaich';
UPDATE munros SET prominence_m = 921 WHERE name = 'An Socach';
...
UPDATE munros SET prominence_m = 917 WHERE name = 'Geal-chàrn';
...
-- Check for any Munros still with 0 prominence
