/*
  # Complete Scottish Munros Database - Additional Data

  1. Data Population
    - Insert comprehensive dataset of Scottish Munros
    - Covers all key mountain ranges and regions
    - Includes detailed climbing information and metadata
    - Uses proper conflict handling to avoid duplicates

  2. Structure
    - Uses DO blocks with individual INSERT statements
    - Proper error handling for existing records
    - Maintains data integrity
*/

-- Insert Scottish Munros data using DO block for proper conflict handling
DO $$
BEGIN
  -- Ben Nevis Group (Lochaber)
  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Ben Nevis') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Bidean nam Bian') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Bidean nam Bian', 1150, 3773, 870, 'Munro', 'Highlands', 'Lochaber', 'NN143542', 56.6700, -5.0700, NULL, 'The highest peak in Argyll, hidden in Glen Coe. A complex mountain with multiple ridges and corries offering challenging climbing.', 4, 7.0, '["Coire Gabhail (Hidden Valley)", "An t-Sron ridge", "Coire nan Lochan"]', '["Late Spring", "Summer", "Early Autumn"]', 'Highest peak in Argyll. Complex mountain with multiple tops and challenging navigation.', 'bidean_nam_bian.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Ben Starav') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Ben Starav', 1078, 3537, 675, 'Munro', 'Highlands', 'Argyll', 'NN125427', 56.5533, -5.0833, NULL, 'A fine mountain at the head of Loch Etive, Ben Starav offers excellent rock climbing and beautiful corrie scenery.', 3, 6.5, '["Glen Etive approach", "Coileitir approach", "Glas Bheinn traverse"]', '["Spring", "Summer", "Autumn"]', 'Excellent rock climbing on Gully Face. Beautiful position at head of Loch Etive.', 'ben_starav.jpg');
  END IF;

  -- Torridon
  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Liathach') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Liathach', 1055, 3461, 671, 'Munro', 'Highlands', 'Torridon', 'NG929580', 57.5500, -5.4833, NULL, 'One of the most spectacular mountains in Scotland, Liathach offers a challenging ridge traverse with incredible exposure and views.', 5, 8.0, '["Northern Pinnacles traverse", "Coire Dubh Mor", "Am Fasarinen traverse"]', '["Summer", "Early Autumn"]', 'Quartzite and sandstone mountain. One of the most challenging Munro traverses in Scotland.', 'liathach.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Beinn Eighe') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Beinn Eighe', 1010, 3314, 632, 'Munro', 'Highlands', 'Torridon', 'NG951595', 57.5667, -5.4500, NULL, 'Britains first National Nature Reserve, Beinn Eighe offers spectacular quartzite ridges and ancient Caledonian pine forest.', 4, 7.0, '["Coire Dubh approach", "Glen Torridon route", "Triple Buttress"]', '["Summer", "Early Autumn"]', 'First National Nature Reserve in Britain. Ancient Caledonian pine forest at base.', 'beinn_eighe.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Beinn Alligin') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Beinn Alligin', 985, 3232, 885, 'Munro', 'Highlands', 'Torridon', 'NG866613', 57.5833, -5.5500, NULL, 'The Jewelled Mountain offers one of the finest ridge walks in Scotland with the famous Horns of Alligin providing spectacular scrambling.', 4, 6.5, '["Coire nan Laogh", "Horns of Alligin traverse", "Tom na Gruagaich route"]', '["Summer", "Early Autumn"]', 'The Jewelled Mountain. Famous for the Horns of Alligin scramble.', 'beinn_alligin.jpg');
  END IF;

  -- Skye Cuillin
  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Sgurr Alasdair') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Sgurr Alasdair', 992, 3255, 992, 'Munro', 'Highlands', 'Skye', 'NG450208', 57.2083, -6.2167, 1873, 'The highest peak on Skye and in the Cuillin, Sgurr Alasdair requires rock climbing skills to reach the summit. Spectacular gabbro climbing.', 5, 10.0, '["Stone Shoot", "South West Ridge", "Great Stone Chute"]', '["Summer"]', 'Highest peak on Skye. Requires rock climbing skills. Named after Alexander Nicolson.', 'sgurr_alasdair.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Sgurr Dearg (Inaccessible Pinnacle)') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Sgurr Dearg (Inaccessible Pinnacle)', 986, 3235, 26, 'Munro', 'Highlands', 'Skye', 'NG444215', 57.2150, -6.2233, 1880, 'The only Munro requiring rock climbing to complete, the Inaccessible Pinnacle is a dramatic blade of gabbro offering the most technical Munro ascent.', 5, 12.0, '["East Ridge (Moderate)", "West Ridge (Difficult)"]', '["Summer"]', 'Only Munro requiring rock climbing. Most technical Munro ascent. Blade of gabbro rock.', 'sgurr_dearg_inaccessible_pinnacle.jpg');
  END IF;

  -- Affric and Cannich
  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Mam Sodhail') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Mam Sodhail', 1181, 3875, 988, 'Munro', 'Highlands', 'Affric', 'NH120253', 57.2833, -5.1500, NULL, 'The highest peak in the Affric area, Mam Sodhail offers excellent views and is often climbed as part of the South Glen Shiel Ridge.', 3, 7.0, '["Glen Affric approach", "Cluanie Inn route", "An Riabhachan traverse"]', '["Spring", "Summer", "Autumn"]', 'Highest peak in Glen Affric area. Excellent views of surrounding peaks and lochs.', 'mam_sodhail.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Carn Eighe') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Carn Eighe', 1183, 3881, 672, 'Munro', 'Highlands', 'Affric', 'NH123262', 57.2917, -5.1417, NULL, 'One of the most remote Munros, Carn Eighe offers a challenging approach through beautiful Glen Affric and spectacular summit views.', 3, 8.0, '["Glen Affric approach", "Loch Mullardoch route", "Beinn Fhionnlaidh traverse"]', '["Summer", "Early Autumn"]', 'One of the most remote Munros. Long approach through beautiful Glen Affric.', 'carn_eighe.jpg');
  END IF;

  -- Knoydart
  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Ladhar Bheinn') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
  ...
  -- Morvern and Ardgour
  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Garbh Bheinn') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Garbh Bheinn', 885, 2903, 885, 'Munro', 'Highlands', 'Ardgour', 'NM904601', 56.7167, -5.7500, NULL, 'A dramatic peak overlooking Loch Linnhe, Garbh Bheinn offers excellent rock climbing and spectacular views across to Mull.', 3, 6.0, '["Coire an Iubhair", "Great Ridge", "Pinnacle Ridge"]', '["Spring", "Summer", "Autumn"]', 'Dramatic peak overlooking Loch Linnhe. Excellent rock climbing opportunities.', 'garbh_bheinn.jpg');
  END IF;

  -- Mull
  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Ben More (Mull)') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Ben More (Mull)', 966, 3169, 966, 'Munro', 'Highlands', 'Mull', 'NM526331', 56.4167, -6.0167, NULL, 'The only Munro on Mull, Ben More offers spectacular island views and a challenging ascent from sea level. Often combined with A Chioch.', 3, 6.5, '["Dhiseig approach", "Glen More route", "A Chioch traverse"]', '["Spring", "Summer", "Autumn"]', 'Only Munro on an island. Spectacular views across the Inner Hebrides.', 'ben_more_mull.jpg');
  END IF;

  -- Mamores
  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Binnein Mor') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Binnein Mor', 1130, 3707, 450, 'Munro', 'Highlands', 'Mamores', 'NN212663', 56.7833, -4.9667, NULL, 'The highest peak in the Mamores, Binnein Mor offers excellent ridge walking and spectacular views of Ben Nevis and the surrounding peaks.', 3, 6.0, '["Kinlochleven approach", "Mamore Lodge route", "Na Gruagaichean traverse"]', '["Spring", "Summer", "Autumn"]', 'Highest peak in the Mamores. Excellent ridge walking with spectacular views.', 'binnein_mor.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Na Gruagaichean') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Na Gruagaichean', 1056, 3465, 56, 'Munro', 'Highlands', 'Mamores', 'NN203652', 56.7750, -4.9750, NULL, 'Part of the Mamores ridge, Na Gruagaichean offers excellent walking with spectacular views. Often climbed with Binnein Mor.', 3, 6.5, '["Via Binnein Mor", "Kinlochleven approach", "Mamore Lodge route"]', '["Spring", "Summer", "Autumn"]', 'Part of the excellent Mamores ridge walk. Name means The Maidens.', 'na_gruagaichean.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'An Gearanach') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('An Gearanach', 982, 3222, 82, 'Munro', 'Highlands', 'Mamores', 'NN188670', 56.7917, -4.9917, NULL, 'A fine peak in the Mamores offering excellent ridge walking and spectacular views. Often climbed as part of the Mamores traverse.', 3, 7.0, '["Ring of Steall", "Kinlochleven approach", "An Garbhanach traverse"]', '["Spring", "Summer", "Autumn"]', 'Part of the famous Ring of Steall walk. Excellent ridge walking.', 'an_gearanach.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Stob Coire a Chairn') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Stob Coire a Chairn', 981, 3218, 81, 'Munro', 'Highlands', 'Mamores', 'NN185661', 56.7833, -4.9917, NULL, 'A prominent peak in the Mamores offering excellent views and ridge walking. Part of the classic Mamores traverse.', 3, 7.0, '["Ring of Steall", "Kinlochleven approach", "Am Bodach traverse"]', '["Spring", "Summer", "Autumn"]', 'Prominent peak in the Mamores. Part of the classic Ring of Steall.', 'stob_coire_a_chairn.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Am Bodach') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Am Bodach', 1032, 3386, 132, 'Munro', 'Highlands', 'Mamores', 'NN169651', 56.7750, -5.0083, NULL, 'The Old Man offers spectacular views down Glen Nevis and across to Ben Nevis. Part of the excellent Mamores ridge.', 3, 6.5, '["Ring of Steall", "Glen Nevis approach", "Sgurr a Mhaim traverse"]', '["Spring", "Summer", "Autumn"]', 'The Old Man - spectacular views down Glen Nevis. Part of Ring of Steall.', 'am_bodach.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Sgurr a Mhaim') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Sgurr a Mhaim', 1099, 3606, 399, 'Munro', 'Highlands', 'Mamores', 'NN164667', 56.7833, -5.0167, NULL, 'A spectacular peak offering one of the finest views of Ben Nevis. The Devils Ridge provides an exciting scramble to the summit.', 4, 6.0, '["Devils Ridge", "Glen Nevis approach", "Sgor an Iubhair traverse"]', '["Spring", "Summer", "Autumn"]', 'Spectacular views of Ben Nevis. Famous Devils Ridge scramble.', 'sgurr_a_mhaim.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Sgor an Iubhair') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Sgor an Iubhair', 1001, 3284, 101, 'Munro', 'Highlands', 'Mamores', 'NN165658', 56.7750, -5.0167, NULL, 'The Peak of the Yew offers excellent views and is often climbed with Sgurr a Mhaim. Part of the western Mamores.', 3, 6.5, '["Via Sgurr a Mhaim", "Glen Nevis approach", "Steall Falls route"]', '["Spring", "Summer", "Autumn"]', 'The Peak of the Yew. Often climbed with Sgurr a Mhaim.', 'sgor_an_iubhair.jpg');
  END IF;

  -- Grey Corries
  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Stob Choire Claurigh') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Stob Choire Claurigh', 1177, 3862, 777, 'Munro', 'Highlands', 'Lochaber', 'NN262739', 56.8250, -4.9000, NULL, 'The highest peak in the Grey Corries, offering excellent ridge walking and spectacular views of Ben Nevis and the surrounding peaks.', 3, 7.0, '["Corriechoille approach", "Lairig Leacach", "Stob Ban traverse"]', '["Spring", "Summer", "Autumn"]', 'Highest peak in the Grey Corries. Excellent ridge walking with quartzite summits.', 'stob_choire_claurigh.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Stob Coire an Laoigh') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Stob Coire an Laoigh', 1116, 3661, 216, 'Munro', 'Highlands', 'Lochaber', 'NN240724', 56.8083, -4.9250, NULL, 'Part of the Grey Corries ridge, offering excellent walking on quartzite peaks with spectacular views.', 3, 7.5, '["Via Stob Choire Claurigh", "Corriechoille approach", "Sgurr Choinnich Mor traverse"]', '["Spring", "Summer", "Autumn"]', 'Part of the Grey Corries ridge. Beautiful quartzite peaks.', 'stob_coire_an_laoigh.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Sgurr Choinnich Mor') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Sgurr Choinnich Mor', 1095, 3593, 195, 'Munro', 'Highlands', 'Lochaber', 'NN227714', 56.7917, -4.9417, NULL, 'A fine peak in the Grey Corries offering excellent ridge walking and spectacular views. The quartzite summit provides excellent grip.', 3, 7.5, '["Grey Corries traverse", "Corriechoille approach", "Stob Ban route"]', '["Spring", "Summer", "Autumn"]', 'Fine peak in Grey Corries. Quartzite summit provides excellent grip.', 'sgurr_choinnich_mor.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Stob Ban') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Stob Ban', 977, 3205, 77, 'Munro', 'Highlands', 'Lochaber', 'NN266722', 56.8083, -4.8917, NULL, 'The White Peak is famous for its quartzite summit that gleams white in sunlight. Offers excellent views and ridge walking.', 3, 6.5, '["Corriechoille approach", "Grey Corries traverse", "Lairig Leacach route"]', '["Spring", "Summer", "Autumn"]', 'The White Peak - quartzite summit gleams white in sunlight.', 'stob_ban.jpg');
  END IF;

  -- Arrochar Alps
  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Ben Vorlich (Loch Lomond)') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Ben Vorlich (Loch Lomond)', 943, 3094, 666, 'Munro', 'Highlands', 'Arrochar', 'NN295124', 56.2333, -4.7500, NULL, 'A popular Munro easily accessible from central Scotland, Ben Vorlich offers excellent views over Loch Lomond and the surrounding hills.', 2, 4.5, '["Ardlui approach", "Inveruglas route", "Little Hills traverse"]', '["All seasons"]', 'Popular with day walkers from Glasgow. Excellent views over Loch Lomond.', 'ben_vorlich_loch_lomond.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Ben Vane') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Ben Vane', 915, 3002, 315, 'Munro', 'Highlands', 'Arrochar', 'NN278098', 56.2083, -4.7750, NULL, 'A steep and challenging Munro in the Arrochar Alps, Ben Vane offers excellent views despite its modest height.', 3, 5.0, '["Inveruglas approach", "Coiregrogain route", "Ben Vorlich traverse"]', '["Spring", "Summer", "Autumn"]', 'Steep and challenging despite modest height. Part of Arrochar Alps.', 'ben_vane.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Ben Ime') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Ben Ime', 1011, 3317, 611, 'Munro', 'Highlands', 'Arrochar', 'NN255085', 56.1917, -4.8083, NULL, 'The highest peak in the Arrochar Alps, Ben Ime offers excellent views and challenging climbing. Often approached via the Cobbler.', 3, 5.5, '["Succoth approach", "Butterbridge route", "The Cobbler traverse"]', '["Spring", "Summer", "Autumn"]', 'Highest peak in Arrochar Alps. Often combined with The Cobbler.', 'ben_ime.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Beinn Bhuidhe') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Beinn Bhuidhe', 948, 3110, 648, 'Munro', 'Highlands', 'Arrochar', 'NN204187', 56.2667, -4.8833, NULL, 'A remote Munro offering excellent views over Loch Fyne and the surrounding hills. Less crowded than other Arrochar peaks.', 2, 5.0, '["Glen Fyne approach", "Inverchorachan route", "Loch Sloy approach"]', '["Spring", "Summer", "Autumn"]', 'Remote peak with excellent views over Loch Fyne. Less crowded.', 'beinn_bhuidhe.jpg');
  END IF;

  -- Trossachs
  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Ben Lomond') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Ben Lomond', 974, 3196, 974, 'Munro', 'Highlands', 'Trossachs', 'NN367028', 56.1917, -4.6333, NULL, 'Scotlands most southerly Munro and one of the most popular, Ben Lomond offers spectacular views over Loch Lomond and easy access from Glasgow.', 2, 4.0, '["Tourist path from Rowardennan", "Ptarmigan route", "Ben Lomond Way"]', '["All seasons"]', 'Most southerly Munro. Most popular mountain in Scotland. Easy access from Glasgow.', 'ben_lomond.jpg');
  END IF;

  -- More Cairngorms
  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Derry Cairngorm') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Derry Cairngorm', 1155, 3789, 155, 'Munro', 'Highlands', 'Cairngorms', 'NO017980', 57.0583, -3.6417, NULL, 'A fine peak in the heart of the Cairngorms, offering excellent plateau walking and spectacular corrie scenery.', 3, 7.0, '["Linn of Dee approach", "Glen Derry route", "Ben Macdui traverse"]', '["Summer", "Early Autumn"]', 'Heart of Cairngorms. Excellent plateau walking and corrie scenery.', 'derry_cairngorm.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Beinn a Chaorainn') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Beinn a Chaorainn', 1082, 3550, 582, 'Munro', 'Highlands', 'Cairngorms', 'NJ045013', 57.0833, -3.6083, NULL, 'A remote Munro in the eastern Cairngorms, offering excellent views and challenging navigation across the plateau.', 3, 8.0, '["Glen Avon approach", "Tomintoul route", "Beinn Bhreac traverse"]', '["Summer", "Early Autumn"]', 'Remote eastern Cairngorms peak. Challenging plateau navigation.', 'beinn_a_chaorainn.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Beinn Bhreac') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Beinn Bhreac', 931, 3054, 331, 'Munro', 'Highlands', 'Cairngorms', 'NJ058971', 57.0500, -3.5917, NULL, 'A rounded hill in the eastern Cairngorms, often climbed with Beinn a Chaorainn. Offers excellent views across the Cairngorm plateau.', 2, 7.5, '["Via Beinn a Chaorainn", "Glen Avon approach", "Tomintoul route"]', '["Summer", "Early Autumn"]', 'Rounded hill in eastern Cairngorms. Often combined with Beinn a Chaorainn.', 'beinn_bhreac.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Lochnagar') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Lochnagar', 1155, 3789, 755, 'Munro', 'Highlands', 'Cairngorms', 'NO244861', 56.9583, -3.2417, NULL, 'A magnificent mountain with spectacular corries and cliffs, Lochnagar is famous for its dramatic north face and royal connections.', 3, 6.5, '["Spittal of Glenmuick", "Glen Muick approach", "Cac Carn Beag traverse"]', '["Spring", "Summer", "Autumn"]', 'Royal connections - beloved by Queen Victoria. Spectacular corries and granite cliffs.', 'lochnagar.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Mount Keen') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Mount Keen', 939, 3081, 939, 'Munro', 'Highlands', 'Cairngorms', 'NO409869', 56.9667, -2.9833, NULL, 'The most easterly Munro, Mount Keen offers excellent views and is often climbed via the historic Mounth Road.', 2, 5.5, '["Glen Tanar approach", "Invermark route", "Mounth Road"]', '["Spring", "Summer", "Autumn"]', 'Most easterly Munro. Historic Mounth Road crossing. Excellent views to North Sea.', 'mount_keen.jpg');
  END IF;

  -- Fisherfield Forest
  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'An Teallach') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('An Teallach', 1062, 3484, 762, 'Munro', 'Highlands', 'Fisherfield', 'NH069844', 57.7667, -5.3167, NULL, 'One of the finest mountains in Scotland, An Teallach offers spectacular ridge walking with dramatic pinnacles and corries.', 5, 9.0, '["Dundonnell approach", "Corrie Hallie route", "Pinnacle Ridge traverse"]', '["Summer", "Early Autumn"]', 'One of the finest mountains in Scotland. Spectacular pinnacle ridge. Remote Fisherfield location.', 'an_teallach.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Mullach Coire Mhic Fhearchair') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Mullach Coire Mhic Fhearchair', 1019, 3343, 219, 'Munro', 'Highlands', 'Fisherfield', 'NH052842', 57.7583, -5.3333, NULL, 'Part of the An Teallach massif, this peak offers spectacular views and challenging ridge walking in remote Fisherfield.', 4, 9.5, '["Via An Teallach", "Dundonnell approach", "Corrie Hallie route"]', '["Summer", "Early Autumn"]', 'Part of An Teallach massif. Remote Fisherfield location with spectacular ridge walking.', 'mullach_coire_mhic_fhearchair.jpg');
  END IF;

  -- Fannichs
  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Sgurr Mor') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Sgurr Mor', 1110, 3642, 710, 'Munro', 'Highlands', 'Fannichs', 'NH203718', 57.6833, -4.9667, NULL, 'The highest peak in the Fannichs, Sgurr Mor offers excellent ridge walking and spectacular views across the northwest Highlands.', 3, 7.5, '["Fannich Lodge approach", "Loch Fannich route", "Beinn Liath Mhor traverse"]', '["Spring", "Summer", "Autumn"]', 'Highest peak in Fannichs. Excellent ridge walking with spectacular northwest Highland views.', 'sgurr_mor_fannichs.jpg');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Sgurr nan Clach Geala') THEN
    INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
    VALUES ('Sgurr nan Clach Geala', 1093, 3586, 293, 'Munro', 'Highlands', 'Fannichs', 'NH184714', 57.6750, -4.9917, NULL, 'A fine peak in the Fannichs offering excellent ridge walking and spectacular views. Often climbed with Sgurr Mor.', 3, 8.0, '["Via Sgurr Mor", "Fannich Lodge approach", "Loch Fannich route"]', '["Spring", "Summer", "Autumn"]', 'Fine Fannichs peak. Often combined with Sgurr Mor for excellent ridge walking.', 'sgurr_nan_clach_geala.jpg');
  END IF;
