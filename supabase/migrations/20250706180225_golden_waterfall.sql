/*
  # Complete Scottish Corbetts Database

  1. New Tables
    - Clears and repopulates `corbetts` table with all 222 authentic Scottish Corbetts
    - Each Corbett includes comprehensive climbing information
    - Proper PostgreSQL array formatting for routes and seasons

  2. Data Quality
    - All 222 Corbetts from official lists
    - Unique names with no duplicates
    - Consistent height and prominence data
    - Regional organization across Scotland
