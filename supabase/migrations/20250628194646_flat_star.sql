...
-- Insert Scottish Munros data (using DO block to handle conflicts)
DO $$
BEGIN
  ...
  INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
  SELECT 'Ben More (Crianlarich)', 1174, 3852, 966, 'Munro', 'Highlands', 'Perthshire', 'NN432244', 56.3978, -4.5689, NULL, 'A prominent peak visible from much of central Scotland, Ben More offers excellent views and is often climbed with neighbouring Stob Binnein.', 3, 5.5, '["Benmore Farm approach", "Glen Dochart route", "Stob Binnein traverse"]', '["Spring", "Summer", "Autumn"]', 'Most southerly Munro over 1000m. Excellent viewpoint for central Scotland.', 'ben_more_crianlarich.jpg'
  WHERE NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Ben More (Crianlarich)');

  INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
  SELECT 'Stob Binnein', 1165, 3822, 319, 'Munro', 'Highlands', 'Perthshire', 'NN434227', 56.3956, -4.5667, NULL, 'Often climbed with Ben More, Stob Binnein offers a fine ridge walk and excellent views. The name means Peak of the Anvil.', 3, 6.0, '["Via Ben More", "Inverlochlarig approach", "Glen Dochart route"]', '["Spring", "Summer", "Autumn"]', 'Connected to Ben More by a fine ridge. Name means Peak of the Anvil.', 'stob_binnein.jpg'
  ...
  -- Affric and Cannich
  INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
  SELECT 'Mam Sodhail', 1181, 3875, 988, 'Munro', 'Highlands', 'Affric', 'NH120253', 57.2833, -5.1500, NULL, 'The highest peak in the Affric area, Mam Sodhail offers excellent views and is often climbed as part of the South Glen Shiel Ridge.', 3, 7.0, '["Glen Affric approach", "Cluanie Inn route", "An Riabhachan traverse"]', '["Spring", "Summer", "Autumn"]', 'Highest peak in Glen Affric area. Excellent views of surrounding peaks and lochs.', 'mam_sodhail.jpg'
  WHERE NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Mam Sodhail');

  INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
  SELECT 'Carn Eighe', 1183, 3881, 672, 'Munro', 'Highlands', 'Affric', 'NH123262', 57.2917, -5.1417, NULL, 'One of the most remote Munros, Carn Eighe offers a challenging approach through beautiful Glen Affric and spectacular summit views.', 3, 8.0, '["Glen Affric approach", "Loch Mullardoch route", "Beinn Fhionnlaidh traverse"]', '["Summer", "Early Autumn"]', 'One of the most remote Munros. Long approach through beautiful Glen Affric.', 'carn_eighe.jpg'
  ...
  -- Morvern and Ardgour
  INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
  SELECT 'Garbh Bheinn', 885, 2903, 885, 'Munro', 'Highlands', 'Ardgour', 'NM904601', 56.7167, -5.7500, NULL, 'A dramatic peak overlooking Loch Linnhe, Garbh Bheinn offers excellent rock climbing and spectacular views across to Mull.', 3, 6.0, '["Coire an Iubhair", "Great Ridge", "Pinnacle Ridge"]', '["Spring", "Summer", "Autumn"]', 'Dramatic peak overlooking Loch Linnhe. Excellent rock climbing opportunities.', 'garbh_bheinn.jpg'
  WHERE NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Garbh Bheinn');

  -- Mull
  INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
  SELECT 'Ben More (Mull)', 966, 3169, 966, 'Munro', 'Highlands', 'Mull', 'NM526331', 56.4167, -6.0167, NULL, 'The only Munro on Mull, Ben More offers spectacular island views and a challenging ascent from sea level. Often combined with A Chioch.', 3, 6.5, '["Dhiseig approach", "Glen More route", "A Chioch traverse"]', '["Spring", "Summer", "Autumn"]', 'Only Munro on an island. Spectacular views across the Inner Hebrides.', 'ben_more_mull.jpg'
  WHERE NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Ben More (Mull)');

  -- Mamores
  INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
  SELECT 'Binnein Mor', 1130, 3707, 450, 'Munro', 'Highlands', 'Mamores', 'NN212663', 56.7833, -4.9667, NULL, 'The highest peak in the Mamores, Binnein Mor offers excellent ridge walking and spectacular views of Ben Nevis and the surrounding peaks.', 3, 6.0, '["Kinlochleven approach", "Mamore Lodge route", "Na Gruagaichean traverse"]', '["Spring", "Summer", "Autumn"]', 'Highest peak in the Mamores. Excellent ridge walking with spectacular views.', 'binnein_mor.jpg'
  WHERE NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Binnein Mor');

  INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
  SELECT 'Na Gruagaichean', 1056, 3465, 56, 'Munro', 'Highlands', 'Mamores', 'NN203652', 56.7750, -4.9750, NULL, 'Part of the Mamores ridge, Na Gruagaichean offers excellent walking with spectacular views. Often climbed with Binnein Mor.', 3, 6.5, '["Via Binnein Mor", "Kinlochleven approach", "Mamore Lodge route"]', '["Spring", "Summer", "Autumn"]', 'Part of the excellent Mamores ridge walk. Name means The Maidens.', 'na_gruagaichean.jpg'
  WHERE NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Na Gruagaichean');

  INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
  SELECT 'An Gearanach', 982, 3222, 82, 'Munro', 'Highlands', 'Mamores', 'NN188670', 56.7917, -4.9917, NULL, 'A fine peak in the Mamores offering excellent ridge walking and spectacular views. Often climbed as part of the Mamores traverse.', 3, 7.0, '["Ring of Steall", "Kinlochleven approach", "An Garbhanach traverse"]', '["Spring", "Summer", "Autumn"]', 'Part of the famous Ring of Steall walk. Excellent ridge walking.', 'an_gearanach.jpg'
  WHERE NOT EXISTS (SELECT 1 FROM munros WHERE name = 'An Gearanach');

  INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
  SELECT 'Stob Coire a Chairn', 981, 3218, 81, 'Munro', 'Highlands', 'Mamores', 'NN185661', 56.7833, -4.9917, NULL, 'A prominent peak in the Mamores offering excellent views and ridge walking. Part of the classic Mamores traverse.', 3, 7.0, '["Ring of Steall", "Kinlochleven approach", "Am Bodach traverse"]', '["Spring", "Summer", "Autumn"]', 'Prominent peak in the Mamores. Part of the classic Ring of Steall.', 'stob_coire_a_chairn.jpg'
  ...
  INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
  SELECT 'Mullach Coire Mhic Fhearchair', 1019, 3343, 219, 'Munro', 'Highlands', 'Fisherfield', 'NH052842', 57.7583, -5.3333, NULL, 'Part of the An Teallach massif, this peak offers spectacular views and challenging ridge walking in remote Fisherfield.', 4, 9.5, '["Via An Teallach", "Dundonnell approach", "Corrie Hallie route"]', '["Summer", "Early Autumn"]', 'Part of An Teallach massif. Remote Fisherfield location with spectacular ridge walking.', 'mullach_coire_mhic_fhearchair.jpg'
  WHERE NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Mullach Coire Mhic Fhearchair');

  -- Fannichs
  INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
  SELECT 'Sgurr Mor', 1110, 3642, 710, 'Munro', 'Highlands', 'Fannichs', 'NH203718', 57.6833, -4.9667, NULL, 'The highest peak in the Fannichs, Sgurr Mor offers excellent ridge walking and spectacular views across the northwest Highlands.', 3, 7.5, '["Fannich Lodge approach", "Loch Fannich route", "Beinn Liath Mhor traverse"]', '["Spring", "Summer", "Autumn"]', 'Highest peak in Fannichs. Excellent ridge walking with spectacular northwest Highland views.', 'sgurr_mor_fannichs.jpg'
  WHERE NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Sgurr Mor');

  INSERT INTO munros (name, height_m, height_ft, prominence_m, classification, region, area, grid_ref, latitude, longitude, first_ascent_year, description, difficulty_rating, estimated_time_hours, popular_routes, best_seasons, significant_info, image_filename)
  SELECT 'Sgurr nan Clach Geala', 1093, 3586, 293, 'Munro', 'Highlands', 'Fannichs', 'NH184714', 57.6750, -4.9917, NULL, 'A fine peak in the Fannichs offering excellent ridge walking and spectacular views. Often climbed with Sgurr Mor.', 3, 8.0, '["Via Sgurr Mor", "Fannich Lodge approach", "Loch Fannich route"]', '["Spring", "Summer", "Autumn"]', 'Fine Fannichs peak. Often combined with Sgurr Mor for excellent ridge walking.', 'sgurr_nan_clach_geala.jpg'
  WHERE NOT EXISTS (SELECT 1 FROM munros WHERE name = 'Sgurr nan Clach Geala');
